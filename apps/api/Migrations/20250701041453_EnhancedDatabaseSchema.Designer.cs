...
namespace TradeMentor.Api.Migrations
{
    ...
    [Migration("20250701041453_EnhancedDatabaseSchema")]
...
#pragma warning disable 612, 618
                    ...
                    b.ToTable("EmotionChecks", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_EmotionCheck_Intensity", "\"Intensity\" >= 1 AND \"Intensity\" <= 5");

                            t.HasCheckConstraint("CK_EmotionCheck_Level", "\"Level\" >= 1 AND \"Level\" <= 10");

                            t.HasCheckConstraint("CK_EmotionCheck_PrimaryEmotion", "\"PrimaryEmotion\" IN ('fear', 'greed', 'confidence', 'anxiety', 'excitement', 'frustration', 'calm', 'fomo')");
                        });
                });
            ...
            modelBuilder.Entity("TradeMentor.Api.Models.Trade", b =>
                {
                    ...
                    b.Property<int?>("ExecutionQuality")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("Trades", t =>
                        {
                            t.HasCheckConstraint("CK_Trade_ExecutionQuality", "\"ExecutionQuality\" >= 1 AND \"ExecutionQuality\" <= 5");

                            t.HasCheckConstraint("CK_Trade_Outcome", "\"Outcome\" IN ('win', 'loss', 'breakeven')");

                            t.HasCheckConstraint("CK_Trade_SetupQuality", "\"SetupQuality\" >= 1 AND \"SetupQuality\" <= 5");
            ...
            modelBuilder.Entity("TradeMentor.Api.Models.UserInsight", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("UserInsights", t =>
                        {
                            t.HasCheckConstraint("CK_UserInsight_ConfidenceScore", "\"ConfidenceScore\" >= 0.00 AND \"ConfidenceScore\" <= 10.00");

                            t.HasCheckConstraint("CK_UserInsight_InsightType", "\"InsightType\" IN ('performance_correlation', 'best_times', 'emotion_pattern', 'streak_milestone')");
                        });
                });

            modelBuilder.Entity("TradeMentor.Api.Models.UserSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("EmotionsLogged")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0);

                    b.Property<decimal?>("SessionQualityScore")
                        .HasColumnType("decimal(3,2)");

                    b.Property<int>("TradesLogged")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0);
                    ...
                    b.ToTable("UserSessions", t =>
                        {
                            t.HasCheckConstraint("CK_UserSession_SessionQualityScore", "\"SessionQualityScore\" >= 0.00 AND \"SessionQualityScore\" <= 10.00");
                        });
                });
